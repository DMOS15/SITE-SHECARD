document.addEventListener('DOMContentLoaded', () => {
  ...
  refreshHistory.onclick = async () => { refreshHistory.disabled = true; try { await refreshSharedData(); render(); } catch (error) { alert(error.message); } finally { refreshHistory.disabled = false; } };
